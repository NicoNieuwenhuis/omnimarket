        ...
        <form @submit.prevent="submitListings">
          <div>
            <div class="form-group">
              ...
              <SelectCategories v-for="categorie in categories" :list="categorie"></SelectCategories>
              ...
              <div  v-if="this.listings.category" class="form-group">
                ...
                <select v-model="listings.pricetype" v-on:change="getPricetype">
            ...
            <div class="col-12 text-center my-3" style="float: left;">
              <div class="imageupload"  @click="onButtonClick2">
...
<div >
        ...
        <div class="imageupload" @click="onButtonClick3">
